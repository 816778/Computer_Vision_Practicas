...
if __name__ == '__main__':
    # Load an image
    image_1 = cv2.cvtColor(cv2.imread('p0/Practice0/365.jpg'),cv2.COLOR_BGR2RGB) # Load image 1 and conversion from BGR 2 RGB
    ...
    image2 = cv2.cvtColor(cv2.imread('p0/Practice0/541.jpg'),cv2.COLOR_BGR2RGB)  # Load image 2 and conversion from BGR to RGB
